            ...
            <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="mt-6">
                <button
                  ...
                  type="button"
                > 
                  <a href="https://twitter.com/Ayush_Jindal_"
                  target="_blank">
                ...
                <button
                  ...
                  type="button"
                >
                  <a href="https://www.facebook.com/ayush.jindal.9659"
                  target="_blank">
                ...
                <button
                  ...
                  type="button"
                >
                  <a href="https://www.instagram.com/ayushjindal_16/"
                  target="_blank">
                ...
                <button
                  ...
                  type="button"
                >
                  <a href="https://medium.com/@ayushjindal15030"
                  target="_blank">
              ...
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <a className="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm"
                         href="https://medium.com/@ayushjindal15030">Blog
                      </a>
                    </li>
                    <li>
                      <a className="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm"
                         href="https://github.com/codes-code">Github
                      </a>
                    </li>
                    <li>
                      <a className="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm"
                         href="https://www.ayushjindal.com/memes">Memes
                      </a>
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-gray-600 font-semibold py-1">
                ...
                <a
                  href="https://www.ayushjindal.com"
